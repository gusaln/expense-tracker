...
interface RecurrenceUpdateFormProps {
  // title: string;
  // buttonText: string;
...
function RecurrenceUpdateForm(props: RecurrenceUpdateFormProps) {
        ...
        <form className="space-y-4" action="" method="post" onSubmit={handleSubmit(onSubmit)}>
          ...
          <FormField
            ...
            input={(props) => (
              <Select
                {...props}
                placeholder="Click to choose a frequency"
...
export default RecurrenceUpdateForm;
